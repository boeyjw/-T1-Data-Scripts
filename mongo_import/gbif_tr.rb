table "gbif_distribution", :rename_to => 'distribution', :embed_in => 'taxon', :on => 'taxon' do
...
table "gbif_multimedia", :rename_to => 'multimedia', :embed_in => 'taxon', :on => 'taxon' do
	column "coreID", :integer, :references => :taxon
...
table "gbif_reference", :rename_to => 'reference', :embed_in => 'taxon', :on => 'taxon' do
	column "coreID", :integer, :references => :taxon
...
table "gbif_vernacularname", :rename_to => 'vernacularname', :embed_in => 'taxon', :on => 'taxon' do
	column "coreID", :integer, :references => :taxon
